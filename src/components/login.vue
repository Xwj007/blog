                    ...
                    if (valid) {                       
                         this.$http.post('/api/login',this.formInline
                            ...
                            if(res.data.err_code==0){
                                ...
                                this.$router.push({name:'Main',params:{nickname:res.data.session},query:{nickname:res.data.session}});
                                //  this.$router.push({name:'Main',params:{nickname:res.data.session}});
                            }      
                            })
                    } else {
